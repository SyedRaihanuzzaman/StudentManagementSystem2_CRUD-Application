package com.raihan.practical6studentmangaementcrud
...
import com.raihan.practical6studentmangaementcrud.adapter.DataAdapter
import com.raihan.practical6studentmangaementcrud.databinding.ActivityMainBinding
import com.raihan.practical6studentmangaementcrud.model.Data
    ...
    override fun onEditItemClick(data: Data) {
        ...
        binding.addBtn.setOnClickListener {
            ...
            if (updateStuid.isNotEmpty() && updateName.isNotEmpty() && updateEmail.isNotEmpty() && updateSubject.isNotEmpty() && updateBirthdate.isNotEmpty()) {
                val updateData = Data(data.id, updateStuid, updateName,updateEmail,updateSubject,updateBirthdate,
                    Timestamp.now())
